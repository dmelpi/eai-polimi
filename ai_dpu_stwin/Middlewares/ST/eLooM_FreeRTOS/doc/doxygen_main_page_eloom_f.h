 ...
 *
 * \section eloom_timestamp_srv Timestamp service
 *
 * The framework provides a timestamp service since version v4.0.0. It is easy to configure and use, and it has been designed to minimize
 * the resource usage in term of hardware and footprint. For more information look at SysTimestamp.h
 *
