...
#define SYS_DBG_TP1_PORT                   LED_GREEN_GPIO_Port
#define SYS_DBG_TP1_PIN                    LED_GREEN_Pin
#define SYS_DBG_TP1_CLK_ENABLE             __HAL_RCC_GPIOH_CLK_ENABLE
#define SYS_DBG_TP2_PORT                   LED_RED_GPIO_Port
#define SYS_DBG_TP2_PIN                    LED_RED_Pin
