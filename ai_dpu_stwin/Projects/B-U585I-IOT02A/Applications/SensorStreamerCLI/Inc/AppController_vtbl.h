...
sys_error_code_t AppController_vtblOnStatusChange(IListener *this); ///< @sa IListener_OnStatusChange

/* IEventListener virtual functions */
void *AppController_vtblGetOwner(IEventListener *_this); ///< @sa IEventListener_GetOwner
void AppController_vtblSetOwner(IEventListener *_this, void *p_owner); ///< @sa IEventListener_SetOwner

/* ISensorEventListener virtual functions */
sys_error_code_t AppController_vtblOnNewDataReady(IEventListener *_this, const SensorEvent *p_evt); ///< @sa ISensorEventListener_OnNewDataReady
