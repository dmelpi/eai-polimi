...
#define SYS_DBG_LPS22HH                    SYS_DBG_ON                 ///< LPS22HH sensor task debug control byte
#define SYS_DBG_ENV                        SYS_DBG_ON                 ///< ENV sensor task debug control byte
#define SYS_DBG_UTIL                       SYS_DBG_ON                 ///< Utility task debug control byte
#define SYS_DBG_SCLI                       SYS_DBG_ON                 ///< Application Controller (console) task debug control byte
...
#define SYS_DBG_TP1_CLK_ENABLE             __HAL_RCC_GPIOH_CLK_ENABLE
#define SYS_DBG_TP2_PORT                   SYS_DBG_TP2_GPIO_Port
#define SYS_DBG_TP2_PIN                    SYS_DBG_TP2_Pin
#define SYS_DBG_TP2_CLK_ENABLE             __HAL_RCC_GPIOH_CLK_ENABLE
...
#define SYS_DBG_TIM_IRQ_N                  TIM6_IRQn
