...
void MX_GPIO_Init(void)
{
  ...
  GPIO_InitStruct.Pin = GPIO_PIN_6|GPIO_PIN_0|GPIO_PIN_5|GPIO_PIN_2
                          |GPIO_PIN_15|GPIO_PIN_12|GPIO_PIN_8|GPIO_PIN_11;
  GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
...
void MX_GPIO_PG2_Init(void)
{
  ...
  /*Configure GPIO pin : LPS22HH IRQ Pin */
  ...
  /* EXTI interrupt init*/
  HAL_NVIC_SetPriority(Mems_INT_LPS22HH_EXTI_IRQn, 5, 0);
  HAL_NVIC_EnableIRQ(Mems_INT_LPS22HH_EXTI_IRQn);
}
