 ...
 * @version 3.0.1
 * @date    21/01/2022 10:35:15
 *
 * @brief Write a greeting message in the debug console.
 *
 * This managed task is responsible Write a greeting message in the debug console
 * with  a fixed period of 1 second.
 *
 *********************************************************************************
 * @attention
 *
