 ...
 *********************************************************************************
 */
#ifndef APPLOWPAWER_H_
#define APPLOWPAWER_H_
...
typedef enum {
  ...
  /**
   * Power mode state used by the SensorManager component. We remap it into E_POWER_MODE_TEST
   */
   ...
   */
  E_POWER_MODE_TEST = 3,           ///< E_POWER_MODE_TEST
