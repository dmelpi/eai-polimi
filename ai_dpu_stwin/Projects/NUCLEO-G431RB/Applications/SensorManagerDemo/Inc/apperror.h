...
#define SYS_SENSOR_TASK_BASE_ERROR_CODE                       SYS_BASE_I2CBUS_TASK_ERROR_CODE + SYS_GROUP_ERROR_COUNT
#define SYS_SENSOR_TASK_OP_ERROR_CODE                         SYS_SENSOR_TASK_BASE_ERROR_CODE + 1

// Utility task error code
#define SYS_BASE_UTIL_TASK_ERROR_CODE                         SYS_SENSOR_TASK_BASE_ERROR_CODE + SYS_GROUP_ERROR_COUNT
