...
#ifndef AI_HAR_NETWORK_H
#define AI_HAR_NETWORK_H
#pragma once
...
/******************************************************************************/
#define AI_HAR_NETWORK_MODEL_NAME          "har_network"
#define AI_HAR_NETWORK_ORIGIN_MODEL_NAME   "har_svc"

/******************************************************************************/
#define AI_HAR_NETWORK_ACTIVATIONS_ALIGNMENT   (4)



/******************************************************************************/
#define AI_HAR_NETWORK_IN_NUM        (1)

AI_DEPRECATED
#define AI_HAR_NETWORK_IN \
  ai_har_network_inputs_get(AI_HANDLE_NULL, NULL)

#define AI_HAR_NETWORK_IN_SIZE { \
  AI_HAR_NETWORK_IN_1_SIZE, \
}
#define AI_HAR_NETWORK_IN_SIZE_BYTES { \
  AI_HAR_NETWORK_IN_1_SIZE_BYTES, \
}
#define AI_HAR_NETWORK_IN_1_CHANNEL     (72)
#define AI_HAR_NETWORK_IN_1_SIZE        (72)
#define AI_HAR_NETWORK_IN_1_SIZE_BYTES  (288)

/******************************************************************************/
#define AI_HAR_NETWORK_OUT_NUM       (2)

AI_DEPRECATED
#define AI_HAR_NETWORK_OUT \
  ai_har_network_outputs_get(AI_HANDLE_NULL, NULL)

#define AI_HAR_NETWORK_OUT_SIZE { \
  AI_HAR_NETWORK_OUT_1_SIZE, \
  AI_HAR_NETWORK_OUT_2_SIZE, \
}
#define AI_HAR_NETWORK_OUT_SIZE_BYTES { \
  AI_HAR_NETWORK_OUT_1_SIZE_BYTES, \
  AI_HAR_NETWORK_OUT_2_SIZE_BYTES, \
}
#define AI_HAR_NETWORK_OUT_1_CHANNEL     (1)
#define AI_HAR_NETWORK_OUT_1_SIZE        (1)
#define AI_HAR_NETWORK_OUT_1_SIZE_BYTES  (4)
#define AI_HAR_NETWORK_OUT_2_CHANNEL     (4)
#define AI_HAR_NETWORK_OUT_2_SIZE        (4)
#define AI_HAR_NETWORK_OUT_2_SIZE_BYTES  (16)

/******************************************************************************/
#define AI_HAR_NETWORK_N_NODES (2)


AI_API_DECLARE_BEGIN

/*!
 * @defgroup har_network
 ...
 * @ref ai_har_network_create. Both the activations memory buffer 
 ...
 * using @ref ai_har_network_get_error
 */
AI_API_ENTRY
 ...
 */
AI_API_ENTRY
ai_buffer* ai_har_network_inputs_get(
 ...
 */
AI_API_ENTRY
ai_buffer* ai_har_network_outputs_get(
  ai_handle network, ai_u16 *n_buffer);
 ...
 * header generated by the code generation tool. See AI_HAR_NETWORK_*
 * defines into file @ref har_network.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
 ...
 */
AI_API_ENTRY
ai_i32 ai_har_network_forward(
  ai_handle network, const ai_buffer* input);

AI_API_DECLARE_END

#endif /* AI_HAR_NETWORK_H */
