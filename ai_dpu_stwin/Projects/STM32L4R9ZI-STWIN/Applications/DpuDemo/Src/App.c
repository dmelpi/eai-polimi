 ...
 */
static AManagedTaskEx *spProcesTask = NULL;
...
sys_error_code_t SysLoadApplicationContext(ApplicationContext *pAppContext)
{
  ...
  xRes = ACAddTask(pAppContext, (AManagedTask*)spProcesTask);
...
sys_error_code_t SysOnStartApplication(ApplicationContext *pAppContext) {
  ...
  ProcesTaskAddDPUListener((ProcesTask_t*)spProcesTask, HelloWorldTaskGetProcEvtListenerIF((HelloWorldTask*)spHelloWorldObj));
