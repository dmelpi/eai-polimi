...
#define SYS_BC_CMD_NOT_SUPPORTED_ERROR_CODE                   SYS_CB_BASE_ERROR_CODE + 1
#define SYS_BC_CMD_EXECUTION_ERROR_CODE                       SYS_CB_BASE_ERROR_CODE + 2
...
#define SYS_BASE_APP_TASK_ERROR_CODE                          SYS_BCP_BASE_ERROR_CODE + SYS_GROUP_ERROR_COUNT
...
#define SYS_BASE_UTIL_TASK_ERROR_CODE                         SYS_BASE_NAI_TASK_ERROR_CODE + SYS_GROUP_ERROR_COUNT
#define SYS_UTIL_TASK_INIT_ERROR_CODE                         SYS_BASE_UTIL_TASK_ERROR_CODE + 1
#define SYS_UTIL_TASK_LP_TIMER_ERROR_CODE                     SYS_BASE_UTIL_TASK_ERROR_CODE + 2
#define SYS_UTIL_TASK_PB_TIMER_ERROR_CODE                     SYS_BASE_UTIL_TASK_ERROR_CODE + 3
#define SYS_UTIL_TASK_LED_TIMER_ERROR_CODE                    SYS_BASE_UTIL_TASK_ERROR_CODE + 4


// AppController error code
#define SYS_BASE_CTRL_TASK_ERROR_CODE                         SYS_BASE_UTIL_TASK_ERROR_CODE + SYS_GROUP_ERROR_COUNT
