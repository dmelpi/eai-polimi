...
static void HAL_TIM7_PeriodElapsedCallback(TIM_HandleTypeDef *htim);
/* Private functions ---------------------------------------------------------*/
/* Imported variables --------------------------------------------------------*/
...
//   * .ioc it is TickPriority  == 16 */
  ...
  /* Update the global tick parameter uwTickPrio */
  ...
  */
  ...
  {
    /* Set the callback to increment the Tick for the HAL */
    HAL_TIM_RegisterCallback(&htim7, HAL_TIM_PERIOD_ELAPSED_CB_ID, HAL_TIM7_PeriodElapsedCallback);
