...
// file LPS22HBTask.c
#define LPS22HB_TASK_CFG_STACK_DEPTH              ((configMINIMAL_STACK_SIZE*3) + (configMINIMAL_STACK_SIZE*4))
#define LPS22HB_TASK_CFG_PRIORITY                 (tskIDLE_PRIORITY+4)
...
// file cli_commands.c
#define CLI_CMD_CFG_BOARD_NAME                    "\tB-L4S5I-IOT01A discovery board"
