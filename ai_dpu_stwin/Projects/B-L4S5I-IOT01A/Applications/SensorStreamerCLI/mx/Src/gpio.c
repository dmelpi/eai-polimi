...
void MX_GPIO_PD10_Init(void)
{
  ...
  /*Configure GPIO pin : LPS22HB IRQ Pin */
  GPIO_InitStruct.Pin =  LPS22HB_INT_DRDY_EXTI10_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_IT_RISING;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(LPS22HB_INT_DRDY_EXTI10_GPIO_Port, &GPIO_InitStruct);

  /* EXTI interrupt init*/
  HAL_NVIC_SetPriority(LPS22HB_INT_DRDY_EXTI10_EXTI_IRQn, 5, 0);
  HAL_NVIC_EnableIRQ(EXTI15_10_IRQn);
}
...
void MX_GPIO_PD15_Init(void)
{
  ...
  /*Configure GPIO pin : HTS221 IRQ Pin */
  ...
  /* EXTI interrupt init*/
  HAL_NVIC_SetPriority(HTS221_DRDY_EXTI15_EXTI_IRQn, 5, 0);
