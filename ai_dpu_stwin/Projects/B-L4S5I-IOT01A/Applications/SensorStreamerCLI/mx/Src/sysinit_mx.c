...
void SystemClock_Config_MX(void) {
	  ...
	  */
	  ...
	  /** Initializes the peripherals clock
	    */
	    PeriphClkInit.PeriphClockSelection = RCC_PERIPHCLK_USB|RCC_PERIPHCLK_ADC|RCC_PERIPHCLK_DFSDM1
	    		|RCC_PERIPHCLK_I2C2|RCC_PERIPHCLK_USART1;
...
/*
  GPIO_InitStruct.Pin = PA0_Pin|PA1_Pin|GPIO_PIN_2|GPIO_PIN_3|GPIO_PIN_6|GPIO_PIN_6
                       |GPIO_PIN_7|PA9_Pin|PA10_Pin|GPIO_PIN_11|GPIO_PIN_12|GPIO_PIN_15;
  GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(GPIOA, &GPIO_InitStruct);

  GPIO_InitStruct.Pin = GPIO_PIN_1|GPIO_PIN_2|GPIO_PIN_3|GPIO_PIN_4|GPIO_PIN_5|GPIO_PIN_6|GPIO_PIN_7|PB8_Pin
