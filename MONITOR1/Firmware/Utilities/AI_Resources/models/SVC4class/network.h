...
#define AI_NETWORK_ORIGIN_MODEL_NAME   "har_svc"
...
#define AI_NETWORK_IN { \
  AI_BUFFER_OBJ_INIT(AI_BUFFER_FORMAT_FLOAT, 1, 1, 72, 1, NULL), \
}
...
#define AI_NETWORK_IN_1_CHANNEL     (72)
...
#define AI_NETWORK_OUT_2_SIZE_BYTES  (AI_NETWORK_OUT_2_SIZE * 4)
