...
__vector_table
        ...
        DCD     DMA1_CH2_IRQHandler               ; DMA1 Channel 2
        DCD     DMA1_CH3_IRQHandler               ; DMA1 Channel 3
        DCD     DMA1_CH4_IRQHandler               ; DMA1 Channel 4
        DCD     DMA1_CH5_IRQHandler               ; DMA1 Channel 5
        DCD     DMA1_CH6_IRQHandler               ; DMA1 Channel 6
        DCD     DMA1_CH7_IRQHandler               ; DMA1 Channel 7
        ...
        DCD     TIM6_DACUNDER_IRQHandler          ; TIM6 and DAC1&2 underrun errors
        DCD     TIM7_IRQHandler                   ; TIM7
        DCD     DMA2_CH1_IRQHandler               ; DMA2 Channel 1
        DCD     DMA2_CH2_IRQHandler               ; DMA2 Channel 2
        DCD     DMA2_CH3_IRQHandler               ; DMA2 Channel 3
        DCD     DMA2_CH4_IRQHandler               ; DMA2 Channel 4
        DCD     DMA2_CH5_IRQHandler               ; DMA2 Channel 5
        ...
        DCD     DMA2_CH6_IRQHandler          ; DMA2 Channel 6
        DCD     DMA2_CH7_IRQHandler          ; DMA2 Channel 7
        ...
        DCD     DSIHSOT_IRQHandler                    ; DSI global interrupt
        DCD     0                                 ; Reserved
        DCD     RNG_HASH_IRQHandler                    ; RNG global interrupt
        ...
        DCD     LCD_TFT_ER_IRQHandler                ; LTDC error global interrupt
...
DMA1_CH5_IRQHandler
        ...
        SECTION .text:CODE:NOROOT:REORDER(1)
DMA1_CH6_IRQHandler
        B DMA1_CH6_IRQHandler

        PUBWEAK DMA1_CH7_IRQHandler
        SECTION .text:CODE:NOROOT:REORDER(1)
DMA1_CH7_IRQHandler
        B DMA1_CH7_IRQHandler
...
UART5_IRQHandler
        ...
        PUBWEAK TIM6_DACUNDER_IRQHandler
        SECTION .text:CODE:NOROOT:REORDER(1)
TIM6_DACUNDER_IRQHandler
        B TIM6_DACUNDER_IRQHandler
...
OTG_FS_IRQHandler
        ...
        SECTION .text:CODE:NOROOT:REORDER(1)
DMA2_CH6_IRQHandler
        B DMA2_CH6_IRQHandler

        PUBWEAK DMA2_CH7_IRQHandler
        SECTION .text:CODE:NOROOT:REORDER(1)
DMA2_CH7_IRQHandler
        B DMA2_CH7_IRQHandler
...
TSC_IRQHandler
       ...
       PUBWEAK DSIHSOT_IRQHandler
       SECTION .text:CODE:NOROOT:REORDER(1)
DSIHSOT_IRQHandler
       B DSIHSOT_IRQHandler

        PUBWEAK RNG_HASH_IRQHandler
        SECTION .text:CODE:NOROOT:REORDER(1)
RNG_HASH_IRQHandler
        B RNG_HASH_IRQHandler
...
LCD_TFT_IRQHandler
        ...
        PUBWEAK LCD_TFT_ER_IRQHandler
        SECTION .text:CODE:NOROOT:REORDER(1)
LCD_TFT_ER_IRQHandler
        B LCD_TFT_ER_IRQHandler
