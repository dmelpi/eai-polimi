...
static const ISensor_vtbl sISM330DHCXTask_AccSensorIF_vtbl = {
    ...
    ISM330DHCXTask_vtblSensorGetDescription
};

static const ISensor_vtbl sISM330DHCXTask_GyroSensorIF_vtbl = {
 ...
 *
 * @return ISM330DHCXTask task object.
 */
static ISM330DHCXTask * ISM330DHCXTaskGetInstance(void);
...
AManagedTaskEx *ISM330DHCXTaskAlloc() {
  ...
  sTaskObj.acc_sensor_if.vptr = &sISM330DHCXTask_AccSensorIF_vtbl;
  sTaskObj.gyro_sensor_if.vptr = &sISM330DHCXTask_GyroSensorIF_vtbl;
...
uint8_t ISM330DHCXTask_vtblAccGetId(ISourceObservable *_this){
  assert_param(_this);
  ISM330DHCXTask *p_ism330dhcx_instance = ISM330DHCXTaskGetInstance();
  uint8_t res = p_ism330dhcx_instance->acc_id;
...
uint8_t ISM330DHCXTask_vtblGyroGetId(ISourceObservable *_this){
  assert_param(_this);
  ISM330DHCXTask *p_ism330dhcx_instance = ISM330DHCXTaskGetInstance();
  uint8_t res = p_ism330dhcx_instance->gyro_id;
...
IEventSrc *ISM330DHCXTask_vtblAccGetEventSourceIF(ISourceObservable *_this){
  assert_param(_this);
  ISM330DHCXTask *p_ism330dhcx_instance = ISM330DHCXTaskGetInstance();
  return p_ism330dhcx_instance->p_acc_event_src;
}

IEventSrc *ISM330DHCXTask_vtblGyroGetEventSourceIF(ISourceObservable *_this){
  assert_param(_this);
  ISM330DHCXTask *p_ism330dhcx_instance = ISM330DHCXTaskGetInstance();
  return p_ism330dhcx_instance->p_gyro_event_src;
}
...
float ISM330DHCXTask_vtblAccGetFS(ISourceObservable *_this){
  assert_param(_this);
  ISM330DHCXTask *p_ism330dhcx_instance = ISM330DHCXTaskGetInstance();
  float res = p_ism330dhcx_instance->sensor_status.pSubSensorStatus[0].FS;
...
float ISM330DHCXTask_vtblAccGetSensitivity(ISourceObservable *_this){
  assert_param(_this);
  ISM330DHCXTask *p_ism330dhcx_instance = ISM330DHCXTaskGetInstance();
  float res = p_ism330dhcx_instance->sensor_status.pSubSensorStatus[0].Sensitivity;
...
float ISM330DHCXTask_vtblGyroGetFS(ISourceObservable *_this){
  assert_param(_this);
  ISM330DHCXTask *p_ism330dhcx_instance = ISM330DHCXTaskGetInstance();
  float res = p_ism330dhcx_instance->sensor_status.pSubSensorStatus[1].FS;
...
float ISM330DHCXTask_vtblGyroGetSensitivity(ISourceObservable *_this){
  assert_param(_this);
  ISM330DHCXTask *p_ism330dhcx_instance = ISM330DHCXTaskGetInstance();
  float res = p_ism330dhcx_instance->sensor_status.pSubSensorStatus[1].Sensitivity;
...
sys_error_code_t ISM330DHCXTask_vtblSensorSetODR(ISensor_t *_this, float ODR){
  ...
  ISM330DHCXTask *p_ism330dhcx_instance = ISM330DHCXTaskGetInstance();
  EPowerMode log_status = AMTGetTaskPowerMode((AManagedTask *)p_ism330dhcx_instance);
  ...
  else
  {
    ...
    res = ISM330DHCXTaskPostReportToBack(p_ism330dhcx_instance, (SMMessage*)&report);
  }
...
boolean_t ISM330DHCXTask_vtblSensorIsEnabled(ISensor_t *_this){
  ...
  if(ISourceGetId((ISourceObservable *)_this) == p_ism330dhcx_instance->acc_id)
    res = p_ism330dhcx_instance->sensor_status.pSubSensorStatus[0].IsActive;
  else if(ISourceGetId((ISourceObservable *)_this) == p_ism330dhcx_instance->gyro_id)
    res = p_ism330dhcx_instance->sensor_status.pSubSensorStatus[1].IsActive;
...
SensorDescriptor_t ISM330DHCXTask_vtblSensorGetDescription(ISensor_t *_this){
  ...
  ISM330DHCXTask *p_ism330dhcx_instance = ISM330DHCXTaskGetInstance();
  return p_ism330dhcx_instance->sensor_descriptor;
}
...
static ISM330DHCXTask* ISM330DHCXTaskGetInstance(){
  return (ISM330DHCXTask*)&sTaskObj;
}
...
//        SYS_DEBUGF(SYS_DBG_LEVEL_VERBOSE, ("ISM330DHCX: new data.\r\n"));
        ...
        if (!SYS_IS_ERROR_CODE(res)) {
          ...
          if((p_obj->sensor_status.pSubSensorStatus[0].IsActive) && (p_obj->sensor_status.pSubSensorStatus[1].IsActive))      /* Read both ACC and GYRO */
          {
            SensorEvent evt_acc, evt_gyro;

            if(p_obj->sensor_status.pSubSensorStatus[0].ODR > p_obj->sensor_status.pSubSensorStatus[1].ODR) /* Acc is faster than Gyro */
            {
            ...
            /* update measuredODR */
            p_obj->sensor_status.pSubSensorStatus[0].MeasuredODR = p_obj->acc_samples_count/delta_timestamp;
            p_obj->sensor_status.pSubSensorStatus[1].MeasuredODR = p_obj->gyro_samples_count/delta_timestamp;
          ...
          else /* Only 1 out of 2 is active */
          {
            ...
            else if(p_obj->sensor_status.pSubSensorStatus[1].IsActive)
            {
            ...
            /* update measuredODR */
            p_obj->sensor_status.pSubSensorStatus[0].MeasuredODR = p_obj->samples_per_it/delta_timestamp;
            p_obj->sensor_status.pSubSensorStatus[1].MeasuredODR = p_obj->samples_per_it/delta_timestamp;
...
static sys_error_code_t ISM330DHCXTaskSensorInit(ISM330DHCXTask *_this) {
  ...
  if(_this->sensor_status.pSubSensorStatus[0].IsActive)
  {
  ...
  if(_this->sensor_status.pSubSensorStatus[1].IsActive)
  {
  ...
  ism330dhcx_wtm_level_acc = ((uint16_t)_this->sensor_status.pSubSensorStatus[0].ODR * (uint16_t)ISM330DHCX_MAX_DRDY_PERIOD);
  ism330dhcx_wtm_level_gyro = ((uint16_t)_this->sensor_status.pSubSensorStatus[1].ODR * (uint16_t)ISM330DHCX_MAX_DRDY_PERIOD);

  if(_this->sensor_status.pSubSensorStatus[0].IsActive && _this->sensor_status.pSubSensorStatus[1].IsActive)      /* Both subSensor is active */
  {
...
static sys_error_code_t ISM330DHCXTaskSensorReadData(ISM330DHCXTask *_this) {
  ...
  ism330dhcx_read_reg(p_sensor_drv, ISM330DHCX_FIFO_STATUS1, &reg0, 1);
  ism330dhcx_read_reg(p_sensor_drv, ISM330DHCX_FIFO_STATUS2, &reg1, 1);

  uint16_t fifo_level = ((reg1 & 0x03) << 8) + reg0;

  if((reg1) & 0x80  && (fifo_level >= _this->samples_per_it) ) {
...
#endif
    if((_this->sensor_status.pSubSensorStatus[0].IsActive) && (_this->sensor_status.pSubSensorStatus[1].IsActive)) {   /* Read both ACC and GYRO */

      uint32_t odr_acc  = (uint32_t)_this->sensor_status.pSubSensorStatus[0].ODR;
      uint32_t odr_gyro = (uint32_t)_this->sensor_status.pSubSensorStatus[1].ODR;
...
static sys_error_code_t ISM330DHCXTaskSensorInitTaskParams(ISM330DHCXTask *_this) {
  ...
  /* SENSOR DESCRIPTOR */
  strcpy(_this->sensor_descriptor.Name, "ISM330DHCX");
  _this->sensor_descriptor.NumberSubSensors = 3;

  /* SUBSENSOR 0 DESCRIPTOR */
  _this->sensor_descriptor.pSubSensorDescriptor[0].IdSub = _this->acc_id;
  _this->sensor_descriptor.pSubSensorDescriptor[0].SensorType = COM_TYPE_ACC;
  _this->sensor_descriptor.pSubSensorDescriptor[0].Dimensions = 3;
  strcpy(_this->sensor_descriptor.pSubSensorDescriptor[0].DimensionsLabel[0], "x");
  strcpy(_this->sensor_descriptor.pSubSensorDescriptor[0].DimensionsLabel[1], "y");
  strcpy(_this->sensor_descriptor.pSubSensorDescriptor[0].DimensionsLabel[2], "z");
  _this->sensor_descriptor.pSubSensorDescriptor[0].DataType = DATA_TYPE_INT16;
  _this->sensor_descriptor.pSubSensorDescriptor[0].pODR[0] = 12.5f;
  _this->sensor_descriptor.pSubSensorDescriptor[0].pODR[1] = 26.0f;
  _this->sensor_descriptor.pSubSensorDescriptor[0].pODR[2] = 52.0f;
  _this->sensor_descriptor.pSubSensorDescriptor[0].pODR[3] = 104.0f;
  _this->sensor_descriptor.pSubSensorDescriptor[0].pODR[4] = 208.0f;
  _this->sensor_descriptor.pSubSensorDescriptor[0].pODR[5] = 416.0f;
  _this->sensor_descriptor.pSubSensorDescriptor[0].pODR[6] = 833.0f;
  _this->sensor_descriptor.pSubSensorDescriptor[0].pODR[7] = 1666.0f;
  _this->sensor_descriptor.pSubSensorDescriptor[0].pODR[8] = 3332.0f;
  _this->sensor_descriptor.pSubSensorDescriptor[0].pODR[9] = 6667.0f;
  _this->sensor_descriptor.pSubSensorDescriptor[0].pODR[10] = COM_END_OF_LIST_FLOAT;
  ...
  strcpy(_this->sensor_descriptor.pSubSensorDescriptor[0].unit, "g");
  _this->sensor_descriptor.pSubSensorDescriptor[0].pFS[0] = 2.0f;
  _this->sensor_descriptor.pSubSensorDescriptor[0].pFS[1] = 4.0f;
  _this->sensor_descriptor.pSubSensorDescriptor[0].pFS[2] = 8.0f;
  _this->sensor_descriptor.pSubSensorDescriptor[0].pFS[3] = 16.0f;
  ...
  _this->sensor_status.pSubSensorStatus[0].FS = 16.0f;
  _this->sensor_status.pSubSensorStatus[0].Sensitivity = 0.0000305f * _this->sensor_status.pSubSensorStatus[0].FS;
  _this->sensor_status.pSubSensorStatus[0].ODR = 6667.0f;
  ...
  _this->sensor_descriptor.pSubSensorDescriptor[1].IdSub = _this->gyro_id;
  _this->sensor_descriptor.pSubSensorDescriptor[1].SensorType = COM_TYPE_GYRO;
  _this->sensor_descriptor.pSubSensorDescriptor[1].Dimensions = 3;
  strcpy(_this->sensor_descriptor.pSubSensorDescriptor[1].DimensionsLabel[0], "x");
  strcpy(_this->sensor_descriptor.pSubSensorDescriptor[1].DimensionsLabel[1], "y");
  strcpy(_this->sensor_descriptor.pSubSensorDescriptor[1].DimensionsLabel[2], "z");
  _this->sensor_descriptor.pSubSensorDescriptor[1].DataType = DATA_TYPE_INT16;
  _this->sensor_descriptor.pSubSensorDescriptor[1].pODR[0] = 12.5f;
  _this->sensor_descriptor.pSubSensorDescriptor[1].pODR[1] = 26.0f;
  _this->sensor_descriptor.pSubSensorDescriptor[1].pODR[2] = 52.0f;
  _this->sensor_descriptor.pSubSensorDescriptor[1].pODR[3] = 104.0f;
  _this->sensor_descriptor.pSubSensorDescriptor[1].pODR[4] = 208.0f;
  _this->sensor_descriptor.pSubSensorDescriptor[1].pODR[5] = 416.0f;
  _this->sensor_descriptor.pSubSensorDescriptor[1].pODR[6] = 833.0f;
  _this->sensor_descriptor.pSubSensorDescriptor[1].pODR[7] = 1666.0f;
  _this->sensor_descriptor.pSubSensorDescriptor[1].pODR[8] = 3332.0f;
  _this->sensor_descriptor.pSubSensorDescriptor[1].pODR[9] = 6667.0f;
  _this->sensor_descriptor.pSubSensorDescriptor[1].pODR[10] = COM_END_OF_LIST_FLOAT;
  ...
  strcpy(_this->sensor_descriptor.pSubSensorDescriptor[1].unit, "mdps");
  _this->sensor_descriptor.pSubSensorDescriptor[1].pFS[0] = 125.0f;
  _this->sensor_descriptor.pSubSensorDescriptor[1].pFS[1] = 250.0f;
  _this->sensor_descriptor.pSubSensorDescriptor[1].pFS[2] = 500.0f;
  _this->sensor_descriptor.pSubSensorDescriptor[1].pFS[3] = 1000.0f;
  _this->sensor_descriptor.pSubSensorDescriptor[1].pFS[4] = 2000.0f;
  _this->sensor_descriptor.pSubSensorDescriptor[1].pFS[5] = 4000.0f;
  _this->sensor_descriptor.pSubSensorDescriptor[1].pFS[6] = COM_END_OF_LIST_FLOAT;

  /* SUBSENSOR 1 STATUS */
  _this->sensor_status.pSubSensorStatus[1].IsActive = TRUE;
  _this->sensor_status.pSubSensorStatus[1].FS = 4000.0f;
  _this->sensor_status.pSubSensorStatus[1].Sensitivity = 0.035f * _this->sensor_status.pSubSensorStatus[1].FS;
  _this->sensor_status.pSubSensorStatus[1].ODR = 6667.0f;
...
#else
  _this->sensor_status.pSubSensorStatus[1].SamplesPerTimestamp = 1000;
#endif
