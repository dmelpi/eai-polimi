...
#define SYS_BASE_APPLICATION_TASK_ERROR_CODE                  SYS_BASE_PRC_TASK_ERROR_CODE + SYS_GROUP_ERROR_COUNT
#define SYS_APPLICATION_TASK_BUFFER_OVF_ERROR_CODE            SYS_BASE_APPLICATION_TASK_ERROR_CODE + 1
