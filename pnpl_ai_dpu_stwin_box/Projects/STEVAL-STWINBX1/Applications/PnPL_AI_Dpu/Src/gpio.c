...
void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pins : PA10 PAPin PA9 PA1
                           PA2 PA3 PA6 */
  GPIO_InitStruct.Pin = GPIO_PIN_10|SW_SEL_Pin|GPIO_PIN_9|GPIO_PIN_1
                          |GPIO_PIN_2|GPIO_PIN_3|GPIO_PIN_6;
  GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(GPIOA, &GPIO_InitStruct);

  /*Configure GPIO pins : PC7 PCPin PC4 PC5 */
  GPIO_InitStruct.Pin = GPIO_PIN_7|ADC_EX_Pin|GPIO_PIN_4|GPIO_PIN_5;
  GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
