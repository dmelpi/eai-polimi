...
#define AI_NETWORK_MODEL_SIGNATURE     "bb9296df997bce278fdab52e9d7bdb7a"
...
#define AI_TOOLS_DATE_TIME   "Tue Nov 22 08:39:13 2022"
...
AI_TENSOR_OBJ_DECLARE(
  ...
  13, 0x0,
  AI_SHAPE_INIT(4, 120, 80, 1, 1), AI_STRIDE_INIT(4, 4, 480, 38400, 38400),
...
AI_TENSOR_OBJ_DECLARE(
  ...
  15, 0x0,
  AI_SHAPE_INIT(4, 80, 5, 1, 1), AI_STRIDE_INIT(4, 4, 320, 1600, 1600),
...
AI_NETWORK_OBJ_DECLARE(
  ...
  AI_BUFFER_INIT(AI_FLAG_NONE,  AI_BUFFER_FORMAT_U8,
    AI_BUFFER_SHAPE_INIT(AI_SHAPE_BCWH, 4, 1, 221780, 1, 1),
    221780, NULL, NULL),
  AI_BUFFER_INIT(AI_FLAG_NONE,  AI_BUFFER_FORMAT_U8,
    AI_BUFFER_SHAPE_INIT(AI_SHAPE_BCWH, 4, 1, 960, 1, 1),
    960, NULL, NULL),
  AI_TENSOR_LIST_IO_OBJ_INIT(AI_FLAG_NONE, AI_NETWORK_IN_NUM, &input_0_output),
  AI_TENSOR_LIST_IO_OBJ_INIT(AI_FLAG_NONE, AI_NETWORK_OUT_NUM, &dense_11_output),
  &dense_8_dense_layer, 0, NULL)
  ...
  ai_network* net_ctx, const ai_network_params* params)
{
  ...
  if (ai_platform_get_activations_map(activations_map, 1, params)) {
    ...
    dense_8_dense_output_array.data = AI_PTR(activations_map[0] + 0);
    dense_8_dense_output_array.data_start = AI_PTR(activations_map[0] + 0);
    dense_8_output_array.data = AI_PTR(activations_map[0] + 0);
    dense_8_output_array.data_start = AI_PTR(activations_map[0] + 0);
    dense_9_dense_output_array.data = AI_PTR(activations_map[0] + 480);
    dense_9_dense_output_array.data_start = AI_PTR(activations_map[0] + 480);
    dense_9_output_array.data = AI_PTR(activations_map[0] + 0);
    dense_9_output_array.data_start = AI_PTR(activations_map[0] + 0);
    dense_10_dense_output_array.data = AI_PTR(activations_map[0] + 480);
    dense_10_dense_output_array.data_start = AI_PTR(activations_map[0] + 480);
    dense_10_output_array.data = AI_PTR(activations_map[0] + 0);
    dense_10_output_array.data_start = AI_PTR(activations_map[0] + 0);
    dense_11_dense_output_array.data = AI_PTR(activations_map[0] + 320);
    dense_11_dense_output_array.data_start = AI_PTR(activations_map[0] + 320);
  ...
  ai_network* net_ctx, const ai_network_params* params)
{
  ...
  if (ai_platform_get_weights_map(weights_map, 1, params)) {
    ...
    dense_8_dense_weights_array.data = AI_PTR(weights_map[0] + 0);
    dense_8_dense_weights_array.data_start = AI_PTR(weights_map[0] + 0);
    dense_8_dense_bias_array.format |= AI_FMT_FLAG_CONST;
    dense_8_dense_bias_array.data = AI_PTR(weights_map[0] + 122880);
    dense_8_dense_bias_array.data_start = AI_PTR(weights_map[0] + 122880);
    dense_9_dense_weights_array.format |= AI_FMT_FLAG_CONST;
    dense_9_dense_weights_array.data = AI_PTR(weights_map[0] + 123360);
    dense_9_dense_weights_array.data_start = AI_PTR(weights_map[0] + 123360);
    dense_9_dense_bias_array.format |= AI_FMT_FLAG_CONST;
    dense_9_dense_bias_array.data = AI_PTR(weights_map[0] + 180960);
    dense_9_dense_bias_array.data_start = AI_PTR(weights_map[0] + 180960);
    dense_10_dense_weights_array.format |= AI_FMT_FLAG_CONST;
    dense_10_dense_weights_array.data = AI_PTR(weights_map[0] + 181440);
    dense_10_dense_weights_array.data_start = AI_PTR(weights_map[0] + 181440);
    dense_10_dense_bias_array.format |= AI_FMT_FLAG_CONST;
    dense_10_dense_bias_array.data = AI_PTR(weights_map[0] + 219840);
    dense_10_dense_bias_array.data_start = AI_PTR(weights_map[0] + 219840);
    dense_11_dense_weights_array.format |= AI_FMT_FLAG_CONST;
    dense_11_dense_weights_array.data = AI_PTR(weights_map[0] + 220160);
    dense_11_dense_weights_array.data_start = AI_PTR(weights_map[0] + 220160);
    dense_11_dense_bias_array.format |= AI_FMT_FLAG_CONST;
    dense_11_dense_bias_array.data = AI_PTR(weights_map[0] + 221760);
    dense_11_dense_bias_array.data_start = AI_PTR(weights_map[0] + 221760);
    return true;
  }
