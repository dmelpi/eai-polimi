...
<label for="collapse-section1" aria-hidden="true">V1.0.0 / 23-March-2022</label>
<div>
...
visit:
[LIS2DU12](https://www.st.com/content/st_com/en/products/mems-and-sensors/accelerometers/lis2du12.html)
:::
::: {.column width="5%"}
