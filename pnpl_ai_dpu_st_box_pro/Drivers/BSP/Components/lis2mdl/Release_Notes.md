...
<label for="collapse-section9" aria-hidden="true">V1.5.0 / 23-March-2022</label>
<div>
...
<label for="collapse-section8" aria-hidden="true">V1.4.0 / 30-September-2021</label>
<div>
...
- Added support for MKI217V1 (LSM6DSOX+LIS2MDL SensorHub DIL24), used in IKS01A3 DataLogExtended example (special case)
...
<label for="collapse-section7" aria-hidden="true">V1.3.1 / 21-April-2021</label>
<div>
...
<label for="collapse-section6" aria-hidden="true">V1.3.0 / 03-March-2021</label>
<div>
...
<label for="collapse-section5" aria-hidden="true">V1.2.2 / 13-November-2020</label>
<div>
...
<label for="collapse-section4" aria-hidden="true">V1.2.1 / 11-October-2019</label>
<div>
...
<label for="collapse-section3" aria-hidden="true">V1.2.0 / 28-May-2019</label>
<div>
