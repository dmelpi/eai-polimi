...
#define AI_NETWORK_MODEL_SIGNATURE     "a0ea8e122a7a66a6686fcee8d6464374"
...
#define AI_TOOLS_DATE_TIME   "Thu Oct 20 15:19:27 2022"
...
AI_TENSOR_OBJ_DECLARE(
  ...
  7, 0x0,
  AI_SHAPE_INIT(4, 128, 50, 1, 1), AI_STRIDE_INIT(4, 4, 512, 25600, 25600),
...
AI_TENSOR_OBJ_DECLARE(
  ...
  9, 0x0,
  AI_SHAPE_INIT(4, 50, 50, 1, 1), AI_STRIDE_INIT(4, 4, 200, 10000, 10000),
...
AI_TENSOR_OBJ_DECLARE(
  ...
  11, 0x0,
  AI_SHAPE_INIT(4, 50, 3, 1, 1), AI_STRIDE_INIT(4, 4, 200, 600, 600),
...
AI_NETWORK_OBJ_DECLARE(
  ...
  AI_BUFFER_INIT(AI_FLAG_NONE,  AI_BUFFER_FORMAT_U8,
    AI_BUFFER_SHAPE_INIT(AI_SHAPE_BCWH, 4, 1, 36612, 1, 1),
    36612, NULL, NULL),
  AI_BUFFER_INIT(AI_FLAG_NONE,  AI_BUFFER_FORMAT_U8,
