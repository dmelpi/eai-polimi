 ...
 */
/* Private Variables -----------------------------------------------------------*/
static const GPIO_TypeDef *BUTTON_PORT[BUTTONn] =
{
...
//static const BSP_BUTTON_GPIO_Init ButtonGpioInit[BUTTONn] = {BUTTON_USER_GPIO_Init, BSP_PB_PWR_Init};
...
int32_t BSP_PB_DeInit(Button_TypeDef Button)
{
  ...
  HAL_GPIO_DeInit((GPIO_TypeDef*) BUTTON_PORT[Button], GPIO_InitStruct.Pin);
