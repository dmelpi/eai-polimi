...
static const LIS2DU12TaskClass_t sTheClass =
{
    ...
    /* class::acc_sensor_if_vtbl virtual table */
    {
        ...
        LIS2DU12Task_vtblAccGetDataType,
        LIS2DU12Task_vtblAccGetDimensions,
...
sys_error_code_t LIS2DU12Task_vtblOnCreateTask(
		AManagedTask *_this,
                                                   ...
                                                   const EPowerMode NewPowerMode)
{
  ...
  else if(NewPowerMode == E_POWER_MODE_STATE1)
  {
    ...
    SYS_DEBUGF(SYS_DBG_LEVEL_VERBOSE, ("LIS2DU12: -> RUN\r\n"));
  }
...
{
  assert_param(_this != NULL);
  LIS2DU12Task *p_if_owner = (LIS2DU12Task*) ((uint32_t) _this - offsetof(LIS2DU12Task, acc_sensor_if));
      ...
      case SM_MESSAGE_ID_DATA_READY:
        {
          ...
          if(p_obj->pIRQConfig == NULL)
          {
            ...
            if(TX_SUCCESS != tx_timer_change(&p_obj->read_timer, AMT_MS_TO_TICKS(p_obj->lis2du12_task_cfg_timer_period_ms), AMT_MS_TO_TICKS(p_obj->lis2du12_task_cfg_timer_period_ms)))
            {
...
//  uint8_t reg0;
  ...
  /* FIFO INT setup */
  lis2du12_int_mode_t int_mode = {0};
  lis2du12_pin_int1_route_t int1_route = {0};
  ...
  *(uint16_t*) &(int1_route) = 0;
  ...
  if(_this->sensor_status.ODR < 2.0f)
  {
    ...
    _this->lis2du12_task_cfg_timer_period_ms = 1000;
  }
...
#if LIS2DU12_FIFO_ENABLED
  lis2du12_fifo_md_t fifo_md = {0};
  lis2du12_fifo_level_get(p_sensor_drv, &fifo_md, (uint8_t*) &_this->samples_per_it);
