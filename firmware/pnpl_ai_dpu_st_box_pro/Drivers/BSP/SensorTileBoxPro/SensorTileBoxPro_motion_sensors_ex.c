...
#if (USE_MOTION_SENSOR_LIS2DU12_0 == 1)
  case LIS2DU12_0:
      /* Use the function LIS2DU12_ACC_SetOutputDataRate_With_Mode for setting the rigth ODR */
      ret = BSP_ERROR_FEATURE_NOT_SUPPORTED;
    break;
#endif
...
//#if (USE_MOTION_SENSOR_LIS2DU12_0 == 1)
//  case LIS2DU12_0:
//    if(LIS2DU12_ACC_Set_Filter_Mode(MotionCompObj[Instance], LowHighPassFlag, filterMode) != BSP_ERROR_NONE)
//    {
//      ret = BSP_ERROR_COMPONENT_FAILURE;
//    }
//    else
