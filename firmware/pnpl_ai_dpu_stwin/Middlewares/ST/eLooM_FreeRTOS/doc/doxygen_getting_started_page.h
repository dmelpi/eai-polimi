 ...
 *        s_pxHelloWorldObj = AppTaskAlloc();
 ...
 *      }
 *
 * Let's give a look to the ::AppTask to see how it is implemented. The framework takes some concept from the OO programming <a href="#footnote-4">[4]</a>.
 ...
 * - AppTask.h: the normal header file
 * - AppTask_vtbl.h: this header declares the redefined functions of the virtual table of the object class.
 * - AppTask.c: the source code.
 *
