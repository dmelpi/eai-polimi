 ...
 *
 * \subsubsection AppTask_SL Service Layer
 * This demo, due to its simplicity, does not provide any service in this layer.
 *
 * \subsubsection AppTask_AL Application Layer
