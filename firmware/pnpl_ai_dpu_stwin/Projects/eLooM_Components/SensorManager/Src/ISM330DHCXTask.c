...
#define ISM330DHCX_TASK_CFG_TIMER_PERIOD_MS          500
#endif
...
AManagedTaskEx *ISM330DHCXTaskAlloc(const void *pIRQConfig, const void *pCSConfig, EBusType eBusType) {
...
static sys_error_code_t ISM330DHCXTaskCreateTimer(ISM330DHCXTask *_this)
{
  ...
  _this->read_fifo_timer = xTimerCreate("ISM330DHCX_T", pdMS_TO_TICKS(ISM330DHCX_TASK_CFG_TIMER_PERIOD_MS), pdFALSE, _this, ISM330DHCXTaskTimerCallbackFunction);
