...
struct _ISourceObservable_vtbl {
  ...
  uint8_t             (*GetDataType)(ISourceObservable *_this); /** @sa ISourceGetDataType() */
  uint16_t            (*GetDimensions)(ISourceObservable *_this); /** @sa ISourceGetDimensions() */
};
