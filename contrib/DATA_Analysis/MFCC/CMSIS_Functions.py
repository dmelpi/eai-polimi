...
# Mel Filter Bank generator
def Mel_filters(nfilt, f_min, f_max, sample_rate, frame_length ):
  ...
  bin_sep=sample_rate/frame_length
  ...
  fbank=np.zeros((nfilt,int(np.floor(frame_length/2))))
