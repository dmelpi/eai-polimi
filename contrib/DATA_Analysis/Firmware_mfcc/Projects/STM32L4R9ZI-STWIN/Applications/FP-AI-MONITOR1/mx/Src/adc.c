...
void MX_ADC1_Init(void)
{
  ...
  */
  ...
  /* TODO: MX issue - the following parameter are not configured by CubeMX */
  ...
  */
  ...
  sConfig.SamplingTime = ADC_SAMPLETIME_12CYCLES_5; /* TODO: MX issue - original value ADC_SAMPLETIME_2CYCLES_5  */
  sConfig.SingleDiff = ADC_SINGLE_ENDED;
  sConfig.OffsetNumber = ADC_OFFSET_1; /* TODO: MX issue - original value ADC_OFFSET_NONE  */
  sConfig.Offset = 0x800; /* TODO: MX issue - original value 0  */
