 ...
 */
inline sys_error_code_t AnalogMicDrvSetDataBuffer(AnalogMicDriver_t *_this, uint32_t *p_buffer, uint32_t buffer_size);
...
SYS_DEFINE_INLINE
sys_error_code_t AnalogMicDrvSetDataBuffer(AnalogMicDriver_t *_this, uint32_t *p_buffer, uint32_t buffer_size)
{
