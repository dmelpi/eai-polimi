...
#define INT_LPS_Pin GPIO_PIN_12
#define INT_LPS_GPIO_Port GPIOG
#define INT_LPS_EXTI_IRQn EXTI12_IRQn
#define STSAFE_RESE_Pin GPIO_PIN_9
#define STSAFE_RESE_GPIO_Port GPIOH
