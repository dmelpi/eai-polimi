...
#define AI_USC_NETWORK_IN_1_HEIGHT      (46)
#define AI_USC_NETWORK_IN_1_WIDTH       (32)
#define AI_USC_NETWORK_IN_1_CHANNEL     (1)
#define AI_USC_NETWORK_IN_1_SIZE        (46 * 32 * 1)
#define AI_USC_NETWORK_IN_1_SIZE_BYTES  (5888)
...
#define AI_USC_NETWORK_OUT_1_CHANNEL     (4)
#define AI_USC_NETWORK_OUT_1_SIZE        (4)
#define AI_USC_NETWORK_OUT_1_SIZE_BYTES  (16)

/******************************************************************************/
#define AI_USC_NETWORK_N_NODES (8)
