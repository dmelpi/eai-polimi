...
#define _FMT_SET(val, mask, bits)   (uint32_t)(((val)&(mask))<<(bits))
#define _FMT_CLR(fmt, mask, bits)   ((uint32_t)(fmt)&(~((mask)<<(bits))))
#define _FMT_GET(fmt, mask, bits)   ((uint32_t)((fmt)>>(bits))&(mask))

/* Flag attributes */
#define AI_SP_FMT_SET_CONST(val)     _FMT_SET(val, _FMT_FLAG_CONST_MASK, _FMT_FLAG_CONST_BITS)
#define AI_SP_FMT_CLR_CONST(fmt)     _FMT_CLR(fmt, _FMT_FLAG_CONST_MASK, _FMT_FLAG_CONST_BITS)
#define AI_SP_FMT_GET_CONST(fmt)     _FMT_GET(fmt, _FMT_FLAG_CONST_MASK, _FMT_FLAG_CONST_BITS)
#define AI_SP_FMT_SET_STATIC(val)    _FMT_SET(val, _FMT_FLAG_STATIC_MASK, _FMT_FLAG_STATIC_BITS)
#define AI_SP_FMT_CLR_STATIC(fmt)    _FMT_CLR(fmt, _FMT_FLAG_STATIC_MASK, _FMT_FLAG_STATIC_BITS)
#define AI_SP_FMT_GET_STATIC(fmt)    _FMT_GET(fmt, _FMT_FLAG_STATIC_MASK, _FMT_FLAG_STATIC_BITS)
#define AI_SP_FMT_SET_SCRATCH(val)   _FMT_SET(val, _FMT_FLAG_SCRATCH_MASK, _FMT_FLAG_SCRATCH_BITS)
#define AI_SP_FMT_CLR_SCRATCH(fmt)   _FMT_CLR(fmt, _FMT_FLAG_SCRATCH_MASK, _FMT_FLAG_SCRATCH_BITS)
#define AI_SP_FMT_GET_SCRATCH(fmt)   _FMT_GET(fmt, _FMT_FLAG_SCRATCH_MASK, _FMT_FLAG_SCRATCH_BITS)

/* Sign information */
#define AI_SP_FMT_SET_SIGN(val)      _FMT_SET(val, _FMT_SIGN_MASK, _FMT_SIGN_BITS)
#define AI_SP_FMT_CLR_SIGN(fmt)      _FMT_CLR(fmt, _FMT_SIGN_MASK, _FMT_SIGN_BITS)
#define AI_SP_FMT_GET_SIGN(fmt)      _FMT_GET(fmt, _FMT_SIGN_MASK, _FMT_SIGN_BITS)

/* Type information */
#define AI_SP_FMT_SET_TYPE(val)       _FMT_SET(val, _FMT_TYPE_MASK, _FMT_TYPE_BITS)
#define AI_SP_FMT_CLR_TYPE(fmt)       _FMT_CLR(fmt, _FMT_TYPE_MASK, _FMT_TYPE_BITS)
#define AI_SP_FMT_GET_TYPE(fmt)       _FMT_GET(fmt, _FMT_TYPE_MASK, _FMT_TYPE_BITS)

/* Padding bits information */
#define AI_SP_FMT_SET_PBITS(val)       _FMT_SET(val, _FMT_PBITS_MASK, _FMT_PBITS_BITS)
#define AI_SP_FMT_CLR_PBITS(fmt)       _FMT_CLR(fmt, _FMT_PBITS_MASK, _FMT_PBITS_BITS)
#define AI_SP_FMT_GET_PBITS(fmt)       _FMT_GET(fmt, _FMT_PBITS_MASK, _FMT_PBITS_BITS)

/* Total number of bits information */
#define AI_SP_FMT_SET_BITS(val)       _FMT_SET(val, _FMT_BITS_MASK, _FMT_BITS_BITS)
#define AI_SP_FMT_CLR_BITS(fmt)       _FMT_CLR(fmt, _FMT_BITS_MASK, _FMT_BITS_BITS)
#define AI_SP_FMT_GET_BITS(fmt)       _FMT_GET(fmt, _FMT_BITS_MASK, _FMT_BITS_BITS)

/* Number of fractional bits information */
#define AI_SP_FMT_SET_FBITS(val)       _FMT_SET(val, _FMT_FBITS_MASK, _FMT_FBITS_BITS)
#define AI_SP_FMT_CLR_FBITS(fmt)       _FMT_CLR(fmt, _FMT_FBITS_MASK, _FMT_FBITS_BITS)
#define AI_SP_FMT_GET_FBITS(fmt)       _FMT_GET(fmt, _FMT_FBITS_MASK, _FMT_FBITS_BITS)
