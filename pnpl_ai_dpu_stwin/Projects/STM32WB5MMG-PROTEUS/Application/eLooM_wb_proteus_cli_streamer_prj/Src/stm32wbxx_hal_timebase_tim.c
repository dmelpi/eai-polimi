...
static void HAL_TIM16_PeriodElapsedCallback(TIM_HandleTypeDef *htim);
/* Private functions ---------------------------------------------------------*/
...
HAL_StatusTypeDef HAL_InitTick(uint32_t TickPriority)
{
  ...
  */
  ...
  if(HAL_TIM_Base_Init(&htim16) == HAL_OK)
  {
    ...
    HAL_TIM_RegisterCallback(&htim16, HAL_TIM_PERIOD_ELAPSED_CB_ID, HAL_TIM16_PeriodElapsedCallback);
