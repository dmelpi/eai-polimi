...
/* CTRL parameters*/
#define SYS_PM_EVENT_PARAM_START_STREAMER       0x01U  ///< Event parameter: start sensor streamer command.
#define SYS_PM_EVENT_PARAM_STOP_STREAMER        0x02U  ///< Event parameter: stop sensor streamer command.
...
typedef enum {
   ...
   */
  E_POWER_MODE_SENSORS_ACTIVE = 2, ///< E_POWER_MODE_SLEEP_1
