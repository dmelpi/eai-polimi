...
#define SYS_BASE_SCLIUTIL_TASK_ERROR_CODE                     SYS_BASE_I2CBUS_TASK_ERROR_CODE + SYS_GROUP_ERROR_COUNT
...
#define SYS_SENSOR_TASK_BASE_ERROR_CODE                       SYS_BASE_SCLIUTIL_TASK_ERROR_CODE + SYS_GROUP_ERROR_COUNT
