...
#define CB_NO_ERROR_CODE                                  0
#ifndef CB_BASE_ERROR_CODE
#define CB_BASE_ERROR_CODE                                CB_NO_ERROR_CODE   + 1
#endif
#define CB_INVALID_ITEM_ERROR_CODE                        CB_BASE_ERROR_CODE + 2
#define CB_FULL_ERROR_CODE                                CB_BASE_ERROR_CODE + 3
#define CB_NO_READY_ITEM_ERROR_CODE                       CB_BASE_ERROR_CODE + 4
#define CB_ERROR_CODE_COUNT                               3

#ifndef CB_HEAP_ALLOC
#define CB_HEAP_ALLOC                                     malloc
#endif

#ifndef CB_HEAP_FREE
#define CB_HEAP_FREE                                      free
#endif
 ...
 *
 * @param _this [IN] specifies a pointer to a ::CircularBuffer object.
 * @param pvItemsBuffer [IN] specifies the memory buffer where the data are stored.
 * @param nItemSize [IN] specifies the size in byte of an item.
 * @return SYS_NO_ERROR_CODE
 */
uint32_t CB_Init(CircularBuffer *_this, void *pItemsBuffer, uint16_t nItemSize);
 ...
 *
 * @param _this [IN] specifies a pointer to a ::CircularBuffer object.
 * @param pItem [OUT] pointer to the new circular buffer item object. If the operation fails the pointer will be set to NULL.
 ...
 *
 * @param _this [IN] specifies a pointer to a ::CircularBuffer object.
 * @param pItem [OUT] pointer to the ready circular buffer item object. If the operation fails the pointer will be set to NULL.
 ...
 *
 * @param _this [IN] specifies a pointer to a ::CircularBuffer object.
 * @param pItem [IN] specifies a pointer to the item to be released.
 ...
 *
 * @param _this [IN] specifies a pointer to a ::CircularBuffer object.
 * @param pItem [IN] specifies a pointer to the item to be marked as ready.
 * @return SYS_NO_ERROR_CODE if success, SYS_CB_INVALID_ITEM_ERROR_CODE otherwise.
 */
 ...
 *         or NULL if pItem doen't belong to the buffer.
 */
